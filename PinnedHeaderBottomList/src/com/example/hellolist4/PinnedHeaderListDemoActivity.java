...
/**
 * An activity that demonstrates various use cases for the
 * {@link PinnedHeaderListView}.
 * If we decide to move PinnedHeaderListView to the framework, this class could
 * go
 * to API demos.
 */
public class PinnedHeaderListDemoActivity extends Activity
{

	public final static class TestPinnedHeaderListAdapter extends
			PinnedHeaderListAdapter
	{
		...
		@Override
		protected void bindView(View v, int partition, Cursor cursor,
				int position)
		{
	...
	protected void onCreate(Bundle bundle)
	{
		...
		final TestPinnedHeaderListAdapter adapter = new TestPinnedHeaderListAdapter(
				this);
